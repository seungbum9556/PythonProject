...
pokemon_dict = {'name': '피카츄', '기술': '백만 볼트'}
...
print('리스트 첫 번째 값 불러 오기', pokemon_list[0])
print('튜플 첫 번째 값 불러 오기', pokemon_tuple[2])
print('딕셔너리 name 불러 오기', pokemon_dict['name'])
print('딕셔너리 기술 불러 오기', pokemon_dict['기술'])
