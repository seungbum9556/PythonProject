...
# 1. 리스트 생성과 접근
pokemon_list = ['피카츄', '피츄', '파이리']
print('리스트 전체:', pokemon_list)
print('첫번째 포켓몬:', pokemon_list[0:4])
print('리스트 길이:', len(pokemon_list))
print('첫번째 포켓몬 문자열 길이:', len(pokemon_list[1]))
print('첫번째 포켓몬 문자열 길이:', len(pokemon_list[0:4][0]))
...
print(fruit_list[1:])
print(fruit_list[-3:])
print(fruit_list[-5:-1:])
print(fruit_list[5:2:-1])
print('스텝 테스트-2:',fruit_list[5:0:-3 ])
print(fruit_list[:3])

# 3. 다양한 데이터 타입
string_list = ['A','B','C']
number_list = [1,2,3,4,5]
boolem_list = [True, False, True]
mixed_list = ['문자열',1,True,3.14]
...
evolution_list[1:3] = ['라이츄 Z', '메가 파이리']
